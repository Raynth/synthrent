	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li a href="{{ route('account.index') }}">Account</li>
            ...
            <div class="col-md-12">
                ...
                <form method="POST" action="{{ route('account.update', $customer->id) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">                            
                            <div class="form-group">
                                <input id="street" type="text" class="input{{ $errors->has('street') ? ' is-invalid' : '' }}" name="street" placeholder="Straat" value="{{ $customer->street }}" required>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <input id="number" type="text" class="input{{ $errors->has('number') ? ' is-invalid' : '' }}" name="number" placeholder="Huisnummer" value="{{ $customer->number }}" required>
                        ...
                        <div class="col-md-6">   
                            <div class="form-group">
                                <input id="zipcode" type="text" class="input{{ $errors->has('zipcode') ? ' is-invalid' : '' }}" name="zipcode" placeholder="Postcode" value="{{ $customer->zipcode }}" required>
                            ...
                            <div class="form-group">
                                <input id="city" type="text" class="input{{ $errors->has('city') ? ' is-invalid' : '' }}" name="city" placeholder="Woonplaats" value="{{ $customer->city }}" required>
                                @if ($errors->has('city'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="col-md-6">                    
                            <div class="form-group">
                                <input id="phone" type="text" class="input{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" placeholder="Telefoonnummer" value="{{ $customer->phone }}" required>
                                @if ($errors->has('phone'))
                                    <span class="invalid-feedback">
                            ...
                            <div class="form-group">
                                <input id="account_number" type="text" class="input{{ $errors->has('account_number') ? ' is-invalid' : '' }}" name="account_number" placeholder="Rekeningnummer" value="{{ $customer->account_number }}" required>
