...
@section('main-content')
                    ...
                    @if (count($verhuren) > 0)
                        <div class="box">
                            <div class="box-header">
                                ...
                                <a href="{{ route('verhuren.create') }}" class="btn btn-primary pull-right">Toevoegen</a>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                    ...
                                    <tbody>
                                        @foreach ($verhuren as $verhuur)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('verhuren.show', $verhuur->id) }}" class="btn btn-primary"><span class="fa fa-search-plus"></a>
                                                    <a href="{{ route('verhuren.edit', $verhuur->id) }}" class="btn btn-warning"><span class="fa fa-edit"></a>
    ...
    <div class="modal fade" id="modal-default">
        ...
        <div class="modal-content">
            ...
            @if (count($verhuren) > 0)
                    <form action="{{ route('verhuren.destroy', $verhuur->id) }}" method="post" class="pull-left">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
