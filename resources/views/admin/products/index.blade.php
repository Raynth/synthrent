                                    ...
                                    <tbody>
                                        @foreach ($products as $product)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('products.show', $product->id) }}" class="btn btn-primary"><span class="fa fa-search-plus"></a>
                                                    <a href="{{ route('products.edit', $product->id) }}" class="btn btn-warning"><span class="fa fa-edit"></a>
